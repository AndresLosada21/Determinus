...
def assurance(*, target: Path | None = None, model: str | None = None, source: bool = False, behavioral: bool = True, core_only: bool = False) -> None:
    if source:
        ...
        print("ADE_V6_SOURCE_PACKAGE_REGRESSION_VALIDATED")
    ...
    if model and effective_behavioral:print("RELEASE_ASSURANCE_VALIDATED: v6 core + durable-kernel contract + behavioral canary")
    elif model:print("RELEASE_ASSURANCE_NOT_CLAIMED: --core-only does not certify durable workflow behavior")
