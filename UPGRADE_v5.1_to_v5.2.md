# Upgrade v5.1.x → v5.2.2

1. Use o release bundle v5.2.2.
2. Execute `migrate-opencode-to-v5.2.2.py` sem `--force` numa instalação gerenciada saudável.
3. Reinicie o OpenCode V2.
4. Rode `validate-opencode-v5.2.2.py --model <provider/model>`.
