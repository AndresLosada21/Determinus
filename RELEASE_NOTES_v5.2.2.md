# ADE v5.2.4 — Consolidation / Reproducibility Release

## Objetivo

v5.2.4 não adiciona uma nova camada de produto. Ela consolida os hotfixes observados durante a validação real da v5.2.1 para que o ZIP distribuído seja exatamente o código testado.
...
- **Upgrade gerenciado**: v5.2.1 passa a ser predecessor suportado explicitamente para migração para v5.2.4.
