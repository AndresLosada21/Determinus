...
---
## Phase 0: Load Skill
`skill("determinus-comp-research")` → two-mode strategy, auto-mode detection, comparison table format, evidence requirements.
...
---
## Write Metadata
After successful completion, call `determinus_project_metadata action:"write"` with:
- `key`: `"comp-scan"`
