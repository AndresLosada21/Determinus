# Compatibility — ADE v5.2.3

| ADE | OpenCode | Python | Estado |
|---|---|---:|---|
| 5.2.3 | V2 Promise plugin API | 3.9+ | source/static validated |
| 5.2.3 | `opencode2 beta-18684` Windows | 3.9+ | revalidate core+contract after upgrade |
