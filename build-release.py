...
def main() -> int:
    ...
    for filename, command in {
        "install-opencode-v6.1.3.py": "install",
        "migrate-to-v6.1.3.py": "migrate",
        "validate-opencode-v6.1.3.py": "validate",
        "regression-opencode-v6.1.3.py": "regression",
        "static-policy-opencode-v6.1.3.py": "static-policy",
        "uninstall-opencode-v6.1.3.py": "uninstall",
    }.items():
    ...
    manifest = {
        ...
        "typed_tools": 35,
        "python_regression_groups": 38,
        "node_plugin_tests": 115,
        "static_policy": "passed",
        "typescript": "passed",
        "migration": "migrate-to-v6.1.3.py",
        "runtime_validation": "target-host-required",
    }
