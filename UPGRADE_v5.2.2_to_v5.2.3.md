# Upgrade ADE v5.2.2 → v5.2.3

Use o migrator do release bundle. A v5.2.3 reduz o surface de tools de owners/children e adiciona o contrato `DELEGATION_DRIVEN`.
