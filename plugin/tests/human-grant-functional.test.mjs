...
function hashResource(o){ return crypto.createHash("sha256").update(canonicalStringify(o)).digest("hex").slice(0,32)}
...
test("L telemetry records authorization without secret", async()=>{
  ...
  try{
    ...
    try{
      ...
      assert.ok(tel2.includes("USER_GRANT"),"telemetry should record USER_GRANT after success")
