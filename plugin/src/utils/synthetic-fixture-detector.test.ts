 ...
 *
 * Pins the patterns that match Determinus's automated validation/parity/latency/
 * roundtrip workflow IDs and summaries. These records leak Determinus state when
