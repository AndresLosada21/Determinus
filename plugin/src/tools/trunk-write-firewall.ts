...
function evaluateTarget(
  ...
  // rq-trunkArtifactAllowlist01: determinus-generated trunk artifacts (e.g.
  // `.adv/github-project.json` regenerated by /determinus-triage) bypass the
 ...
 * `advance-meta` spec (`rq-twf01.7`) and `determinus_INSTRUCTIONS.md` ("Residual
