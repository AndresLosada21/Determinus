---
name: determinus-slop-detection
...
Reusable methodology for `/determinus-slop-scan` and hardening flows. Detect AI-generated quality issues with deterministic checks first, heuristic scanners second. Command owns orchestration, state mutation, and gate flow; skill gives read-only method.
...
- Do NOT invoke `/determinus-*` slash commands.
