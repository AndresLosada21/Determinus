...
- Never poll CI from the main agent's chat/tool turns; spawn `determinus-ci-waiter` instead.
...
| One-shot TDD | Use `determinus_run_test` or repo equivalent, not `bin/oc-test`. |
