...
metadata:
  priority: medium
  source: determinus-improve-command
---
...
Methodology for `/determinus-improve`: find evidence-backed improvement opportunities without mutating ADV state. Command owns target resolution, tool calls, and research-pack write; skill owns scan rubric, report structure, and artifact schema.
...
- Follow-up: {/determinus-proposal | /determinus-task | /determinus-audit | /determinus-tron}
```
...
5. **Next commands** — `/determinus-proposal <summary>`, `/determinus-task`, `/determinus-audit`, `/determinus-tron`
...
| Open Questions for Research | questions future `/determinus-discover` should answer |
