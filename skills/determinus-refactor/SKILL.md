...
metadata:
  priority: medium
  source: determinus-refactor-command
---
...
Methodology for `/determinus-refactor`: reconcile stale proposals with current code and archived history. Command owns ADV mutations, sub-agent dispatch, and validation; skill owns selection and analysis rubric.
...
```text
/determinus-refactor batch mode
