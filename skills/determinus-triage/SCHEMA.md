# determinus-triage Schemas

## Inventory record

```jsonc
{
  "source": "github-issue | github-project | determinus-change | determinus-epic | wisdom | note | todo",
  "ref": "<stable-ref>",
  "title": "<short-title>",
...
```jsonc
{
  "source": "determinus-change | determinus-epic | github-issue | wisdom | note | todo",
  "ref": "<stable-ref>",
